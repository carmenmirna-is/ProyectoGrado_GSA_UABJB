...
urlpatterns = [
    ...
    path('eliminar_solicitud/<int:solicitud_id>/', views.eliminar_solicitud, name='eliminar_solicitud'),  # ✅ CORREGIDO
    ...
    path('cancelar-evento/', views.cancelar_evento, name='cancelar_evento'),
    path('aprobar-con-conflicto/<int:solicitud_id>/', views.aprobar_con_conflicto, name='aprobar_con_conflicto'),  # ✅ CORREGIDO
]