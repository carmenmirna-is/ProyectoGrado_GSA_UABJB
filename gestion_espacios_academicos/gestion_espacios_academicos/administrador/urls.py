...
urlpatterns = [
    path('', views.dashboard_administrador, name='dashboard_administrador'),
    ...
    path('editar_facultad/<int:pk>/', views.editar_facultad, name='editar_facultad'),
    ...
    path('editar_carrera/<int:pk>/', views.editar_carrera, name='editar_carrera'),
